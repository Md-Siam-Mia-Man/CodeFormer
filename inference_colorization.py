...
if __name__ == "__main__":
    ...
    for i, img_path in enumerate(input_img_list):
        ...
        assert input_face.shape[:2] == (
            512,
            512,
        ), "Input resolution must be 512x512 for colorization."
        # input_face = cv2.resize(input_face, (512, 512), interpolation=cv2.INTER_LINEAR)
        input_face = img2tensor(input_face / 255.0, bgr2rgb=True, float32=True)
