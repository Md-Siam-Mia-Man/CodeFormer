...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--save_root", type=str, default="./experiments/pretrained_models/vqgan"
    )
    parser.add_argument("--codebook_size", type=int, default=1024)
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="./experiments/pretrained_models/vqgan/net_g.pth",
    )
    ...
    vqgan = ARCH_REGISTRY.get("VQAutoEncoder")(
        512, 64, [1, 2, 2, 4, 4, 8], "nearest", codebook_size=codebook_size
    ).to(device)
